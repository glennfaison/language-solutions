...
class ProfileInfo extends React.Component {
  renderQuoteList() {
    if (!this.props.thisUser.quoteList) { return; }
    return this.props.thisUser.quoteList.map(quote => (
          ...
          <div className="pb-4">
            <ul className="list-group list-group-flush">
              ...
              <li className="list-group-item bg-transparent">
                ...
                <Link to={"mailto:" + this.props.thisUser.email}>
                  {this.props.thisUser.email}
                </Link>
              </li>
              <li className="list-group-item bg-transparent">
